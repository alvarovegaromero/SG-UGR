...
import { MyPolyhedron } from './MyPolyhedron.js'
...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    // Un suelo
    //this.createGround (); No lo creo para ver todos los ejes
    ...
    this.ejespoliedro = new THREE.AxesHelper (5);
    ...
    this.poliedro = new MyPolyhedron(this.gui, "Controles del poliedro");
    ...
    this.ejespoliedro.add(this.poliedro);
    this.ejespoliedro.position.set (-10, -10, 0);
